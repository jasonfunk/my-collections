...
interface StarWarsCatalogCardProps {
  catalogItem: StarWarsCatalogItem;
  userItem?: UserStarWarsItem;
}

export function StarWarsCatalogCard({ catalogItem, userItem }: StarWarsCatalogCardProps) {
  ...
  return (
    <Card
      className={cardClass}
      onClick={() => navigate(`/collections/star-wars/${catalogItem.id}`)}
    >
      {/* Photo / placeholder */}
      <div className="flex h-32 items-center justify-center rounded-t-lg bg-amber-500/10 text-amber-300 overflow-hidden">
...
export function StarWarsCatalogCardSkeleton() {
  return (
    <Card>
